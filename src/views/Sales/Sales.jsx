    ...
    return (
        <div className='pr-5 py-8 flex flex-col gap-5'>
            ...
            <div id='graphs' className=' grid grid-cols-12 gap-5' >
                <div className='lg:col-span-4 col-span-12'>
                    <Card title='Sales' isTitleDefaultColor={true} titleSize={'text-lg'} className={'flex flex-col justify-between h-full'}>
                ...
                <div className='lg:col-span-8 col-span-12'>
                    <Card title='Revenue' isTitleDefaultColor={true} titleSize={'text-lg'} className="flex flex-col h-full">
            ...
            <div className='grid grid-cols-12 gap-5' >
                <div className='lg:col-span-8 col-span-12'>
                    <Card title='Revenue' isTitleDefaultColor={true} titleSize={'text-lg'} className={'h-full'}>
                ...
                <div className='lg:col-span-4 col-span-12'>
                    <Card title='Sales by Country' isTitleDefaultColor={true} titleSize={'text-lg'} className={'h-full'}>
