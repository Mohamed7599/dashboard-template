            ...
            <div className='grid grid-cols-12'>
                <Card className={'col-span-12 bg-gradient-dark '}>
                    ...
                    <div className='grid grid-cols-12 px-2 py-3 divide-slate-400 items-center m-3 gap-y-3'>
                        <div className='lg:col-span-4 md:col-span-6 col-span-12 md:border-b-0 border-b pb-2 md:border-r flex lg:justify-start justify-center'>
                        ...
                        <div className='lg:col-span-4 md:col-span-6 col-span-12 pb-2 border-b md:border-b-0 lg:border-r flex justify-center'>
                            <div className='flex gap-2 items-center'>
